<template>
  <div class="hand hhand-compact active-hand">
    ...
    <div
      v-for="(c, i) of cards" :key="`${i}`"
      :class="`card ${getSuit0(c)} rank${getRank(c)}`"
      :style="`cursor: move; z-index: ${c};`"
    >
      <div class="face"></div>
    </div>
    <div class="card clubs rank7" style="transform: translate(83px, -137px); cursor: move; z-index: 54;"><div class="face"></div></div>
    -->
    <div id="hand1"></div>
  </div>
</template>
